...
function error-message {
  echo "Sorry! An error has occured" >&2
}
...
--ipconfig          : prints ip data

--memory            : prints ram data

--disk              : prints storage data

--cpu               : prints processor data
...
function cleanup {
  rm /tmp/sysinfo.$$ /tmp/businfo.$$ /tmp/cpuinfo.$$ /tmp/memoryinfo.$$ && echo "Temporary Files have been removed."
  exit
}
